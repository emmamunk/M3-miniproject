...
It goes from 1 to 16, where most have 1-4 people.
...
Number of bathrooms goes from 40 to 100, where 80 is the most common. 
...
Here, we want to look at the listing and we're choosing not to look at price and id and price intrvals for nlp. 
...
fit_dt = train(x = x_train, 
                ...
                method = "rpart") 
```
Adn then printing it for $$n_tune=$$
